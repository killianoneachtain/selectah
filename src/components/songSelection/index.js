...
class SongSelection extends Component{
    ...
    handleClick = (e) => {    
      ...
      console.log("ReleaseID : ", this.props.releaseID)
      ...
      trackPromise(fetch(`/songSearch/${this.props.releaseID}/${this.props.artistName}/${this.props.releaseTitle}/${this.props.song}`)
          .then(res => res.json())   
